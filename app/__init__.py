...
wsgi_app = webapp2.WSGIApplication([
    prefix(app.config.PATH_PREFIX, [
        ...
        prefix('/groups', [
            ...
            route(r'/delete-redirect/', 'app.controllers.groups.DeleteWithRedirect'),
        ...
        prefix('/lists', [
            ...
            route(r'/update/gift/', 'app.controllers.lists.UpdateGift'),
            route(r'/update/survey/', 'app.controllers.lists.UpdateSurvey'),
            route(r'/delete/', 'app.controllers.lists.Delete'),
            route(r'/delete-redirect/', 'app.controllers.lists.DeleteWithRedirect'),
